  ...
  <div class="advanced-example">
    ...
    <div class="control-panel">
      <a-space>
        ...
        <a-button @click="toggleSearch">Toggle Search ({{ showSearch ? 'Hide' : 'Show' }})</a-button>
        ...
        <div class="table-header-actions">
          <a-space>
            ...
            <a-dropdown>
              ...
              <a-button>More Actions <DownOutlined /></a-button>
            </a-dropdown>
          </a-space>
        </div>
      </template>
...
const columns = ref<BaseColumn[]>([
  ...
  },
  {
    ...
    customRender: ({ text }: { text: string[] }) =>
      h('div', text.map(tag =>
        h('a-tag', { color: 'blue', style: 'margin-right: 4px;' }, tag)
      ))
  },
  {
    title: 'Status',
...
const fetchData = async (params: Record<string, any>): Promise<RequestResult> => {
  ...
  if (params.sortField === 'id' && params.sortOrder) {
    filteredData.sort((a, b) =>
      params.sortOrder === 'ascend' ? a.id - b.id : b.id - a.id
    )
  }
